...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Made explicit (rather than left as the implicit 12MB default) with headroom above the
        // largest Filament-declared field cap in the app (news cover_path: 8MB) — see
        // public/.user.ini for why the raw PHP-side ceiling, not this one, was the actual cause
        // of a real camera photo failing to upload.
        'rules' => ['required', 'file', 'max:15360'],         // 15MB
